...
const pageConfig: PageConfig = {
  ...
  links: [
    ...
    { link: 'https://atos.pp.ua/', label: '博客' },
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://atos.pp.ua/',
      statusPageLink: 'https://atos.pp.ua/',
    ...
    },
    {
      ...
      name: 'atos',
      method: 'HEAD',
      target: 'https://atos.us.ci/',
      statusPageLink: 'https://atos.us.ci/',
    ...
    },
    {
      ...
      name: 'atozo',
      method: 'HEAD',
      target: 'https://atozo.wordpress.com/',
      statusPageLink: 'https://atozo.wordpress.com/',
